...
{
    public class StationStructureModel
    {
        ...
        public StationStructureModel() { }

        public StationStructureModel(int id, string parent, string memberName, string memberType, int memberOrder, string memberDescription1, string memberDescription2, string memberDescription3, string memberValues, string taskXrefName, int visible, int global1, int base1, int maxLength, int minValue, int maxValue, string exclusionString, string version, string memberGroup)
        {
            Id = id;
            Parent = parent;
